...
<script type="text/javascript">
	function deliver(id){
		if(confirm("确定发货吗？")){
			window.location.href="commitDeliver?id="+id;
		}
	}
</script>
<style type='text/css'>	
...
<body>
<div style="padding-left:50px;padding-right:230px;"><font size="6" color="blue">待发货订单信息列表：</font><br /></div>
<table align="center">
	<tr>
	...
	<s:iterator id="viewOrder" status="st" value="viewOrderList">
		...
		<tr>
			...
			<td>${userName}</td>
			<td>${stateDes}</td>
			<td><input type="button" value="发货" onclick="deliver('${id}');"/></td>
		</tr>
	</s:iterator>
</table>
